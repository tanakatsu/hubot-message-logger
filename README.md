# hubot-message-logger

hubot-message-logger is a chat bot built on the [Hubot][hubot] framework. It was
...
### Running hubot-message-logger Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start hubot-message-logger locally by running:
